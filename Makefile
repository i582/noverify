...
stat-master:
	...
	go build -pkgdir ./noverify-master -o ./noverify-master/noverify
	./noverify-master/noverify check -output=reports-master.json -output-json ./src/tests/golden/testdata
	ls
